...
def run_multihead_self_attention(
    ...
    """
    module = MultiHeadSelfAttention(d_model, num_heads, rope=None)
    module.load_state_dict(
        {
...
def run_multihead_self_attention_with_rope(
    ...
    module = MultiHeadSelfAttention(d_model, num_heads, rope=rope)
    module.load_state_dict(
        {
            "q_proj.weight": q_proj_weight,
            "k_proj.weight": k_proj_weight,
        ...
        strict=False,  # RoPE cos/sin are non-persistent buffers, not in this dict
    )
...
def run_transformer_block(
    ...
    """
    rope = RotaryPositionalEmbedding(theta, d_model // num_heads, max_seq_len)
    module = TransformerBlock(d_model, num_heads, d_ff, rope=rope)
    module.load_state_dict(weights, strict=False)  # rope cos/sin buffers not in dict
    return module(in_features)
